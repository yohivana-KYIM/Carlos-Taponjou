...
export const translations: Record<Lang, Dict> = {
  ...
  en: {
    ...
    experience: {
      ...
      counter: "assignments",
      items: [
        { role: "Business Intelligence Developer", company: "International Council for Voluntary Agencies (ICVA)", period: "Nov. 2024 – Feb. 2025 · 5 months", location: "Senegal", project: "Humanitarian aid localization barometer (USAID-funded)", highlights: ["Integrating heterogeneous data sources (APIs, relational databases, flat files) with format harmonization", "Building automated, resilient and monitorable ETL/ELT pipelines", "Defining per-country KPIs and dynamic Power BI dashboards"] },
        { role: "Data Analyst", company: "Impact-Initiatives", period: "Sep. 2022 – Sep. 2024 · 24 months", location: "Central African Republic, Uganda", project: "Multi-sector needs assessment of populations (OCHA)", highlights: ["Building a data warehouse and automated ETL/ELT processes", "Dimension and fact tables, BI solutions (reports, cubes, dashboards)", "Automated quality controls and statistical analysis focal point"] },
        { role: "Data Analyst", company: "iMMAP", period: "Apr. 2022 – Jun. 2022 · 3 months", location: "Cameroon", project: "Technical capacity building in information management (OCHA)", highlights: ["Designing multidimensional schemas and data warehouses", "Developing ETL/ELT and documenting data flows and catalog", "Automated quality controls and anomaly detection"] },
        { role: "Data Analyst", company: "INTERSOS", period: "Sep. 2019 – Feb. 2022 · 31 months", location: "Cameroon", project: "Assistance to people affected by disasters and armed conflicts (OCHA, ECHO)", highlights: ["Maintaining and developing data warehouses and ETL/ELT pipelines", "Continuous improvement of analytics systems", "Statistical reports and interactive visualizations for decision-making"] },
        { role: "Data Analyst", company: "Ministry of Livestock and Agriculture", period: "Oct. 2016 – Feb. 2019 · 29 months", location: "Cameroon", project: "General Census of Agriculture and Livestock (RGAE)", highlights: ["Data management and analysis solutions for the census", "Data collection tools, sampling and analysis plan", "Supervising collection, cleaning and analysis outputs (web maps, dashboards)"] },
      ],
    },
    showcase: {
