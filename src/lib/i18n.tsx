...
export const translations: Record<Lang, Dict> = {
  fr: {
    ...
    skills: {
      ...
      items: [
        { category: "Outils Business Intelligence", items: "Power BI, Tableau, DAX, SQL, Python, R, Power Query", years: "6 ans" },
        { category: "Machine Learning / IA", items: "Régression linéaire, Classification, Random Forest, LSTM", years: "1 an" },
        { category: "ETL / ELT", items: "Microsoft Fabric, Azure Synapse, Azure Data Factory, Azure Databricks", years: "5 ans" },
        { category: "Cloud", items: "Azure", years: "5 ans" },
        { category: "Langages de programmation", items: "Python, R et SQL", years: "6 ans" },
        { category: "Bases de données", items: "PostgreSQL, MySQL, Azure SQL Database", years: "6 ans" },
        { category: "Entrepôt de données", items: "Warehouse, Data Lake, Lakehouse", years: "4 ans" },
        { category: "Big Data", items: "Spark, Hadoop", years: "4 ans" },
        { category: "Modélisation & cadre de référence", items: "JIRA, Méthode Scrum, Méthode Agile", years: "6 ans" },
        { category: "Versionning", items: "Git et GitHub", years: "6 ans" },
      ],
    },
    experience: {
      tag: "✨ Expériences",
  ...
  en: {
    ...
    skills: {
      ...
      items: [
        { category: "Business Intelligence Tools", items: "Power BI, Tableau, DAX, SQL, Python, R, Power Query", years: "6 yrs" },
        { category: "Machine Learning / AI", items: "Linear Regression, Classification, Random Forest, LSTM", years: "1 yr" },
        { category: "ETL / ELT", items: "Microsoft Fabric, Azure Synapse, Azure Data Factory, Azure Databricks", years: "5 yrs" },
        { category: "Cloud", items: "Azure", years: "5 yrs" },
        { category: "Programming Languages", items: "Python, R and SQL", years: "6 yrs" },
        { category: "Databases", items: "PostgreSQL, MySQL, Azure SQL Database", years: "6 yrs" },
        { category: "Data Warehousing", items: "Warehouse, Data Lake, Lakehouse", years: "4 yrs" },
        { category: "Big Data", items: "Spark, Hadoop", years: "4 yrs" },
        { category: "Modeling & Frameworks", items: "JIRA, Scrum, Agile", years: "6 yrs" },
        { category: "Version Control", items: "Git and GitHub", years: "6 yrs" },
      ],
    },
    experience: {
      tag: "✨ Experience",
